...
function updateUIText() {
  ...
  const apiPortLabel = document.querySelector('label[for="apiPort"]');
  if (apiPortLabel) apiPortLabel.textContent = t('apiPort');
  
  const tokenPortLabel = document.querySelector('label[for="tokenPort"]');
  if (tokenPortLabel) tokenPortLabel.textContent = t('tokenPort');
